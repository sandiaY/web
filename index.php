          ...
          <form class="col s12" action="proceso.php" method="POST" >
            ...
            <div class="row">
              ...
              <label style="float: left;">
                <a class="blue-text" href="admin.php"><b>Inicia sesión como administrador</b></a>
              </label>
              <br>
           ...
           <button class="btn waves-effect waves-light" type="submit" value="Aceptar" name="action">Acceder  
