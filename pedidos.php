...
<body>
  ...
  <nav>
    ...
    <div class="nav-wrapper green accent-2">
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li>
          <a href="predidos.php">Mis pedidos
            <i class="material-icons">thumb_up</i>
          </a>
        </li>
        <li>
  ...
  <h1 id="encima" align="center">Mis pedidos</h1>
  
  <br>
  <div class="container">
    <div class="collection">

      <a href="#!" class="collection-item">Pedido de hoy: 18-04-2018
      ...
      <a href="#!" class="collection-item">Pedido de: 17-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
      ...
      <a href="#!" class="collection-item">Pedido de: 15-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
      ...
      <a href="#!" class="collection-item">Pedido de: 12-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
      ...
      <a href="#!" class="collection-item">Pedido de: 10-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
      ...
      <a href="#!" class="collection-item">Pedido de: 09-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
      ...
      <a href="#!" class="collection-item">Pedido de: 07-04-2018
        <div class="switch" align="right">
          <label>
            NO RECIBIDO
            <input type="checkbox">
